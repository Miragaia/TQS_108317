...
public class PageObjectTest {
    ...
    public void translatedTest() {
        ...
        nameInput.sendKeys("Miragaia");
        addressInput.sendKeys("Rua Vou Ali Ja Venho");
        cityInput.sendKeys("Viseu");
        stateInput.sendKeys("Viseu");
        zipCodeInput.sendKeys("3515-189");
        ...
        nameOnCard.sendKeys("Miguel Miragaia");
